...
async function main() {
  ...
  await db.affiliateCommissionLedger.create({
    data: {
      affiliateUserId: affiliateUser.id,
      referredUserId: affiliateUser.id, // self-refer for test
      level: 1,
      amountCents: 123456,
      currency: 'EUR',
      reason: 'Test commission for Jan 2026',
      availableAt: new Date('2026-01-15'),
