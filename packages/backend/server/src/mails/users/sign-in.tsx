...
export default function SignIn(props: SignInProps) {
  return (
    <Template>
      <Title>Sign in to Subsumio Cloud</Title>
      <Content>
        <P>You are signing in to Subsumio. Here is your code:</P>
...
SignIn.PreviewProps = {
  url: 'https://app.subsum.io/magic-link?token=123456&email=test@test.com',
  otp: '123456',
};
