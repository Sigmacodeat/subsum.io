...
export const Renderers = {
  //#region Test
  TestMail: make(TestMail, 'Test Email from Subsumio'),
  //#endregion

  //#region User
  SignIn: make(SignIn, 'Sign in to Subsumio'),
  SignUp: make(SignUp, 'Your Subsumio account is waiting for you!'),
  SetPassword: make(SetPassword, 'Set your Subsumio password'),
  ChangePassword: make(ChangePassword, 'Modify your Subsumio password'),
  ...
  TeamLicense: make(
    TeamLicense,
    'Your Subsumio self-hosted team workspace license is ready'
  ),
  //#endregion
} as const;
