      ...
      <section className="section-padding bg-gradient-to-br from-emerald-600 via-emerald-700 to-cyan-700 text-white text-center relative overflow-hidden noise-overlay">
        ...
        <div className="container-wide relative z-10">
          ...
          <ScrollReveal delay={200} direction="up" distance={15}>
            ...
            <Link
              href="/pricing"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-primary-200/60 bg-gradient-to-r from-primary-700 to-cyan-600 px-8 py-4 text-base font-semibold text-white shadow-[0_18px_42px_-20px_rgba(8,145,178,0.9)] transition-all duration-300 hover:-translate-y-0.5 hover:from-primary-800 hover:to-cyan-700 hover:shadow-[0_24px_48px_-20px_rgba(8,145,178,1)] active:translate-y-0 active:shadow-[0_14px_32px_-18px_rgba(8,145,178,0.9)] sm:min-w-[220px] sm:px-10 sm:py-5 sm:text-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-100 focus-visible:ring-offset-2 focus-visible:ring-offset-emerald-800"
            >
              {t('ctaButton')}
