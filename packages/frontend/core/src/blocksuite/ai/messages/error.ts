...
const PaymentRequiredErrorRenderer = (host?: EditorHost | null) => html`
  <ai-error-wrapper
    .text=${"You've reached the current usage cap for Subsumio AI. You can subscribe to Subsumio AI(with free 7-day-trial) to continue the AI experience!"}
    .actionText=${'Upgrade'}
...
const LoginRequiredErrorRenderer = (host?: EditorHost | null) => html`
  <ai-error-wrapper
    .text=${'You need to log in to Subsumio Cloud to continue using Subsumio AI.'}
    .actionText=${'Login'}
