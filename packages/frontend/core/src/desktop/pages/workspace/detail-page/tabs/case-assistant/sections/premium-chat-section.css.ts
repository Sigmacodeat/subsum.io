...
// ── Copilot Intelligence panel (confidence + reasoning) ─────────────────────

export const intelligencePanel = style({
  marginTop: 10,
  display: 'flex',
  flexDirection: 'column',
  gap: 8,
  border: `0.5px solid ${glassStroke}`,
  borderRadius: 10,
  background: 'color-mix(in srgb, var(--affine-background-primary-color) 88%, transparent)',
  padding: '8px 10px',
});
...
export const confidenceWarnings = style({
  margin: 0,
  paddingLeft: 16,
  color: cssVarV2('text/secondary'),
  fontSize: 11,
...
export const reasoningDetails = style({
  borderTop: `0.5px dashed ${glassStroke}`,
  paddingTop: 6,
});
...
export const reasoningList = style({
  margin: '6px 0 0',
  paddingLeft: 16,
  display: 'flex',
  flexDirection: 'column',
...
export const reasoningMeta = style({
  color: cssVarV2('text/secondary'),
  fontWeight: 500,
});
...
export const feedbackPanel = style({
  ...
  borderRadius: 10,
  padding: '8px 10px',
  background: 'color-mix(in srgb, var(--affine-background-primary-color) 90%, transparent)',
  display: 'flex',
  flexDirection: 'column',
  gap: 6,
});
...
export const feedbackActions = style({
  display: 'flex',
  gap: 8,
  justifyContent: 'flex-end',
});

export const feedbackSubmitButton = style({
  borderRadius: 8,
  border: `0.5px solid color-mix(in srgb, ${cssVarV2('button/primary')} 35%, transparent)`,
  background: 'color-mix(in srgb, var(--affine-primary-color) 12%, transparent)',
  color: cssVarV2('text/primary'),
  fontSize: 12,
  fontWeight: 650,
...
export const feedbackCancelButton = style({
  borderRadius: 8,
  border: `0.5px solid ${glassStroke}`,
  background: 'transparent',
  color: cssVarV2('text/secondary'),
